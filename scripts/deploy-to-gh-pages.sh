...
# This script bypasses GitHub Actions artifact system
# and deploys directly to GitHub Pages

set -e

echo "🚀 Starting direct deployment to gh-pages branch..."
...
# Create CNAME file if it exists
if [ -f "CNAME" ]; then
    cp CNAME .
fi
...
- Build: $(date)
- Method: Direct gh-pages deployment
