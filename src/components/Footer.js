            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center mb-3">
                    ...
                    <div className="flex items-center space-x-4 opacity-80 hover:opacity-100 duration-300 order-4">
                        ...
                        <Link className="w-10 h-10 flex items-center justify-center bg-slate-800 rounded-full hover:bg-slate-700 transition-colors" title="Links" href="/links"><span className="material-symbols-outlined text-white text-xl">link</span></Link>
