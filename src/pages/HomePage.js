                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center relative z-10 py-8 sm:py-12 md:py-20">
                    ...
                    <div className="order-1 md:order-2 relative group px-6 sm:px-10 md:px-0">
                        ...
                        <AccessibleImage 
                            ...
                            className="relative z-10 w-full max-w-[160px] sm:max-w-[200px] md:max-w-md mx-auto rounded-lg shadow-2xl transform md:rotate-3 transition-transform duration-500 hover:rotate-0"
                            width={280}
                            height={400}
                            mobileWidth={160} // Mobile-optimized width
                            mobileHeight={240} // Mobile-optimized height
                            priority={true}
                        />
                    </div>
                </div>
