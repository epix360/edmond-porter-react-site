                    ...
                    <form className="max-w-2xl mx-auto space-y-6 text-left" onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input 
                                    className="bg-[#2F364B] border-0 border-b-2 border-outline-variant text-[#C7CAD1] p-3 rounded-t-lg focus:border-secondary focus:ring-0" 
                                    placeholder="Name" 
                                    name="name"
                                    id="name"
                                    value={formData.name}
                        ...
                        <div>
                            ...
                            <input 
                                className="w-full bg-[#2F364B] border-0 border-b-2 border-outline-variant text-[#C7CAD1] p-3 rounded-t-lg focus:border-secondary focus:ring-0" 
                                placeholder="Subject" 
                                name="subject"
                                id="subject"
                        ...
                        <div>
                            ...
                            <textarea 
                                className="w-full bg-[#2F364B] border-0 border-b-2 border-outline-variant text-[#C7CAD1] p-3 rounded-t-lg focus:border-secondary focus:ring-0 resize-none" 
